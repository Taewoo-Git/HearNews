...
if(getUrl[0] == 'https://news.naver.com/main/list.nhn') {
    ...
    for(cnt = 0; cnt < contentList.length; cnt++){
        ...
        contentTitle.push(document.querySelectorAll('dl')[cnt].querySelectorAll('dt')[dtCount].innerText);
...
////////////////////////////////////////////////////////////////////////여기까지 속보 구역입니당!/////////////////////////////////////////////////////////////////////////////
    ...
    for(cnt = 0; cnt < contentList.length; cnt++){
        ...
        contentTitle.push(document.getElementsByClassName('ranking_headline')[cnt].querySelector('a').innerText);
